...
(function(window) {
    ...
    5. **الوصول إلى GitHub:** لديك صلاحية الوصول الكاملة لقراءة وتعديل ملفات المشروع في مستودع GitHub الخاص بالمستخدم عبر الأدوات المخصصة (read_file, multi_replace_file_content, listGithubFiles). لا تعتذر أبداً عن عدم القدرة على الوصول، بل استخدم الأدوات مباشرة عند الحاجة.
