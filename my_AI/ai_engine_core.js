...
const TOOL_GROUPS = {
    CORE: ["architecture_loop", "runtime_verify", "read_file", "write_file", "replace_file_content", "multi_replace_file_content", "thought", "repairSystem", "request_tool_discovery", "list_files", "analyze_file", "searchCode", "fast_file_search", "discovery_scan"],
    ...
    try {
        ...
        try {
            ...
            toolResult = {
                ...
                try {
                    const scanResult = await performCloudArchitectureDiscovery(safePath || "");
                    toolResult = runUniversalArchitectLoop(scanResult, { environment: "GitHub Cloud", objective: args?.objective || "", constraints: args?.constraints || {} });
